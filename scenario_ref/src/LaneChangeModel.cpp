...
double LaneChangeModel::getLaneChangeMetric(Car *car, Lane::NeighboringObjects &sameNeighbors, Lane *otherLane, Lane::NeighboringObjects &otherNeighbors, bool isLeftLane) {
...
double LaneChangeModel::calculateLaneChangeMetric(Car *car, Lane::NeighboringObjects &sameNeighbors, Lane::NeighboringObjects &otherNeighbors, bool isLeftLane) {
